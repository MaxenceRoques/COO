...
import dependencies.Capacity;
import dependencies.FoodType;
import dependencies.Menu;
import dependencies.Restaurant;
import dependencies.strategy.FidelityStrategy;
import dependencies.strategy.HappyHourStrategy;
import dependencies.strategy.StudentStrategy;
...
public class RestaurantDatabase {
    ...
    static {
        for (StackTraceElement element : Thread.currentThread().getStackTrace()) {
            if (element.getClassName().startsWith("org.junit.") ||
                ...
                DATABASE_FILE = "src/test/resources/data/restaurants.json";
            }
        }
        if (DATABASE_FILE == "") {
            DATABASE_FILE = "../database/restaurants.json";
        }
    }
    ...
    public void removeRestaurantById(int id) throws RestaurantNotFoundException {
        restaurants.remove(getRestaurantById(id));
        saveRestaurants();
    }
